...
* 💻 Passionate about building **Web Applications**, **Backend Systems**, and **Software Solutions**.
* 🚀 **Current Focus:** Developing applications with **Java Spring Boot**, **React**, and modern software architectures.
* 📚 **Learning Next:** Improving **System Design**, **Cloud Deployment**, and **DevOps practices**.
* 🤝 **Open to Collaboration:** Software Engineering projects, Backend development, and Web applications.
* 🎯 Looking for opportunities as a **Software Engineer Intern / Java Backend Intern**.
...
<img src="https://skillicons.dev/icons?i=java,kotlin,spring,react,js,ts,html,css,bootstrap,tailwind,mysql,mongodb,firebase,git,github,docker&perline=8" />
